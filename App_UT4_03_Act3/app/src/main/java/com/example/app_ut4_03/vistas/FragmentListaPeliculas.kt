...
class FragmentListaPeliculas : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        peliculasViewModel.peliculas.observe(viewLifecycleOwner){
            binding.apply {
                ...
                recyclerViewPeliculas.adapter = PeliculasAdapter(
                    lista,
    ...
    {
        val accion = FragmentListaPeliculasDirections.actionFragmentListaPeliculasToFragmentDetalle(pelicula=pelicula)
